...
import com.haris.myskin.adapter.ProductSunscreenAdapter
import com.haris.myskin.databinding.ActivityProductSunscreenBinding
import com.haris.myskin.model.ProductImage

class ProductSunscreenActivity : AppCompatActivity() {
    private lateinit var binding: ActivityProductSunscreenBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityProductSunscreenBinding.inflate(layoutInflater)
        setContentView(binding.root)
        supportActionBar?.setTitle(R.string.sun_screentl)
        ...
        binding.btaboutus.setOnClickListener {
            ...
            val recyclerView = findViewById<RecyclerView>(R.id.rvSunscreen)
            recyclerView.layoutManager = LinearLayoutManager(this)
            recyclerView.setHasFixedSize(true)
            recyclerView.adapter = ProductSunscreenAdapter(this, images)
        }
    }
